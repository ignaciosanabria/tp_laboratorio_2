...
namespace Navegador
{
    public partial class frmWebBrowser : Form
    {
        ...
        {
            //Mostrara a partir del ToolStripMenuItem el historial de paginas
        ...
        {
            // La barra de progreso vuelve a cero
            ...
            try
            {
                ...
                downloader.eventoProgreso += new Descargador.EventProgress(this.ProgresoDescarga);
                downloader.eventoCompleted += new Descargador.EventCompleted(this.FinDescarga);
            ...
            {
                // en caso de fallar, lanzo un mensaje de error
                MessageBox.Show(exc.Message, "ERROR");
            }
            finally
            {
                // Al terminar guardo la url que se buscó en el historial.
